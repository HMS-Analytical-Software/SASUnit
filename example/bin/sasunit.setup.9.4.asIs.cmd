...
SET SASUNIT_TEST_SCENARIO_ROOT=%prj_folder%saspgm\
SET SASUNIT_TESTDB_PATH=%SASUNIT_PROJECT_ROOT%doc\sasunit\%SASUNIT_LANGUAGE%
SET SASUNIT_LOG_PATH=%SASUNIT_PROJECT_ROOT%doc\sasunit\%SASUNIT_LANGUAGE%
SET SASUNIT_SCN_LOG_PATH=%SASUNIT_PROJECT_ROOT%doc\sasunit\%SASUNIT_LANGUAGE%\log
SET SASUNIT_REPORT_PATH=%SASUNIT_PROJECT_ROOT%doc\sasunit\%SASUNIT_LANGUAGE%\doc
SET SASUNIT_RESOURCE_PATH=%SASUNIT_ROOT%resources
SET SASUNIT_RUNALL=%SASUNIT_PROJECT_ROOT%saspgm\run_all.sas
