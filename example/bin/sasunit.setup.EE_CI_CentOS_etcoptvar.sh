...
export SASUNIT_SASPATH=/opt/sas/sas94M7/SASFoundation/$SASUNIT_SAS_VERSION/bin
export SASUNIT_SAS_EXE=$SASUNIT_SASPATH/sas_$SASUNIT_LANGUAGE
export SASUNIT_SAS_CFG=/opt/sas/sas94M7/SASFoundation/$SASUNIT_SAS_VERSION/nls/$SASUNIT_LANGUAGE/sasv9.cfg

# --------------------------------------------------------------------------------
# --- EnvVars for SAS Unit Configuration -----------------------------------------
export SASUNIT_ETC_PATH=/etc/opt/SASUnit
...
export SASUNIT_REPORT_PATH=$SASUNIT_VAR_PATH/example/$SASUNIT_LANGUAGE/doc
export SASUNIT_RESOURCE_PATH=$SASUNIT_ETC_PATH/resources
export SASUNIT_RUNALL=$SASUNIT_OPT_PATH/example/saspgm/run_all.sas
