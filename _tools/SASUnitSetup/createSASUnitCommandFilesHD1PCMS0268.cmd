...
"%SASUNIT_SAS_PATH%\%SASUNIT_SAS_VERSION%\sas.exe" -no$syntaxcheck -noovp -nosplash -sysin "%SASUNIT_TOOL_ROOT%\CreateSASUnitCommandFilesWIN.sas" -log "%SASUNIT_TOOL_ROOT%/CreateSASUnitCommandFilesHD1PCMS0268.log"
