%macro _createConfigFile(i_projectRootFolder=
   ...
   data _NULL_;
      ...
      put "/**";
      put "   \copyright  Copyright 2010-2023 HMS Analytical Software GmbH, http://www.analytical-software.de";
      put "               This file is part of SASUnit, the Unit testing framework for SAS(R) programs.";
      put "               For copyright information and terms of usage under the GNU Lesser General Public License see included file README.md";
