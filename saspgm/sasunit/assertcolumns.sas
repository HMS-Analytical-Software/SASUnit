/**EN 
   ...
   \brief      Assessment whether there are differences between the values of 
   ...
   \sa         \$HeadURL: file:///P:/hms/00507_sasunit/svn/branches/v00.903L/saspgm/sasunit/assertcolumns.sas $

   \param   i_expected     data set with expected values
   \param   i_actual       data set with actual values
   \param   i_desc         Description of the assertion to be assessed
...
%ELSE %DO;
   ...
   TITLE "Prüfbericht - Vergleich zweier Dateien";
   FOOTNOTE;
   PROC COMPARE
      BASE=&i_expected 
      COMPARE=&i_actual
