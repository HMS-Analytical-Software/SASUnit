/** \file
   ...
   \return    ODS-Dokumente mit den Inhalten der Bibliotheken und eine SAS Datei mit dem vergelichsergebnis.
*/ 
/** \cond */ 
...
%MACRO assertLibrary (
   ...
   %if (&AnzCompares. > 0) %then %do;
      ...
      %do i=1 %to &AnzCompares.;
         ...
         proc compare 
            base=&i_actual..&&memname&i. 
            compare=&i_expected..&&memname&i.
