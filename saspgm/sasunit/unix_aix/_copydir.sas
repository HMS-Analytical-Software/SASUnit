/**
   ...
   \sa         \$HeadURL$
   \copyright  TCopyright 2010-2023 HMS Analytical Software GmbH, http://www.analytical-software.de
               his file is part of SASUnit, the Unit testing framework for SAS(R) programs.
