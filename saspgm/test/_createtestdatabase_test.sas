/** \file
   ...
   \brief      Test of _createtestdatabase.sas
...
%initScenario (i_desc=Test of _createtestdatabase.sas);

%macro testcase(i_object=_createtestdatabase.sas, i_desc=%str(Correct call));
   /*****************
   documentation
   ******************
   setup  [...] 
   ...
   *****************/
   ...
   /* call */
   %_createtestdatabase(libref=_target);
   %endTestcall()
   ...
   %assertColumns(i_expected=_test.cas
                 ,i_actual  =_target.cas
                 ,i_desc    =Compare cas table
                 );
