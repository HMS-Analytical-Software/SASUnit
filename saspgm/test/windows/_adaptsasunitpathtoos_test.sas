...
%macro testcase(i_object=_adaptsasunitpathtoos.sas, i_desc=%str(Call with simple paths));
   ...
   *****************/
   ...
   /* call */
   %let l_sasunitPath1 = %_adaptSASUnitPathToOS(C:/TEMP/Test/);
   %let l_sasunitPath2 = %_adaptSASUnitPathToOS(C:/TEMP/Test);
...
%macro testcase(i_object=_adaptsasunitpathtoos.sas, i_desc=%str(Call with paths containing wildcards));
   ...
   *****************/
   ...
   /* call */
   %let l_sasunitPath1 = %_adaptSASUnitPathToOS(C:/TEMP/Test/%str(*)_test.sas);
   %let l_sasunitPath2 = %_adaptSASUnitPathToOS(C:/TEMP/Test/%str(*));
...
%macro testcase(i_object=_adaptsasunitpathtoos.sas, i_desc=%str(Call with paths containing blanks));
   ...
   *****************/
   ...
   /* call */
   %let l_sasunitPath1 = %_adaptSASUnitPathToOS(C:/TEMP/SAS Temporary Files/Test/);
   %let l_sasunitPath2 = %_adaptSASUnitPathToOS(C:/TEMP/SAS Temporary Files/Test);
...
%macro testcase(i_object=_adaptsasunitpathtoos.sas, i_desc=%str(Call with paths containing blanks and wildcards));
   ...
   *****************/
   ...
   /* call */
   %let l_sasunitPath1 = %_adaptSASUnitPathToOS(C:/TEMP/SAS Temporary Files/Test/%str(*)_test.sas);
   %let l_sasunitPath2 = %_adaptSASUnitPathToOS(C:/TEMP/SAS Temporary Files/Test/%str(*));
