/** \file
   ...
   \brief      Test of _createtestdatacas.sas
...
%initScenario (i_desc=Test of _createtestdatacas.sas);

%macro testcase(i_object=_createtestdatacas.sas, i_desc=%str(Correct call));
   /*****************
   documentation
   ******************
   setup  [...] 
   ...
   *****************/
   ...
   /* call */
   %_createtestdatacas(libref=_target);
   %endTestcall()
