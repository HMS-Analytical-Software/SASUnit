/*
  ...
  - we are a SAS macro project and no javasxritp project
  - SAS has a limitation of characerts that can be put in the meta tag of an HTML page.
    So I prefer to use a name that let's recognise what's going on.
*/
