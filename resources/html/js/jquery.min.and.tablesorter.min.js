/*
  Hi guys,
  I know there are many good reasons to keep those javascript funtions in seperate files. Like
  - showing responsibility
  - encaüsulation (Informtaion hiding)
  - Keeping seperate thins apart
  BUT: I have two good reasons to put them in one file
  - we are a SAS macro project and no javascript project
  - SAS has a limitation of characerts that can be put in the header tag of an HTML page.
...
/*
   ***********************************************************
   Start of jquery tablesorter 2.0
...
/*
   ***********************************************************
   Start of jquery savesort widget
